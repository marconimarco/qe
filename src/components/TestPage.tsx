...
const SECTOR_DATA: Record<string, { icon: string; scenarios: SectorScenario[] }> = {
  ...
  "Energia e Utilities": {
    ...
    scenarios: [
      ...
      { id: "ene_c_3", name: "Dispacciamento Energetico e Ottimizzazione della Rete Elettrica (OPF)", type: "classical", modelCode: "Python_HPC_GridOPF", focus: "Gestione Rete", description: "Gestione dei flussi di potenza e massimizzazione della longevità della rete elettrica" },
